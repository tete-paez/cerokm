...
// // const sum = 0;
// const sum = numbers.reduce((acumulador, numero) => {
...
// const numbers = [6, 1, 34, 94, 3, 17];
// // const mul = 0;
// const mul = numbers.reduce((acumulador, numero) => {
//     //console.log({ acumulador, numero });
//     return acumulador * numero
// })
// console.log(mul);
...
// const notaFinal = notasDeTPs.reduce((acumulador, numero) => {
//     console.log({ acumulador, numero });
//     return acumulador + numero;
//   });
...
const listaLibrosHTML = librosDeJS.reduce((acumulador, libro) => {
...
// // // codea debajo de este comentario la solucion al ejercicio
// const sinRepetidos = numeros.reduce((acumulador, nums) => {
//     if (!acumulador.includes(nums)){
//         acumulador.push(nums)
//     }
//     return acumulador
// }, [ ]);//los corchetes []son el segundo parametr porque nos pide un array nuevo asi que los [ serian ese array nuevo vacio]
...
// const numerosPares = masNumeros.reduce((acumulador, numerosP) => {
//     if (numerosP % 2 === 0) {
//         acumulador.push(numerosP);
//     }
//     return acumulador
// }, []) ;
...
// codea acá tu solución
const numerosImpares = masNumeros.reduce((acumulador, numerosI) => {
    if (numerosI % 2 != 0) {
        acumulador.push(numerosI);
    }
    return acumulador
}, []) ;
